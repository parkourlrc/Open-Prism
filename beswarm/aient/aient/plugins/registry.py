    ...
    def register(self,
        ...
        def decorator(func: Callable):
            ...
            try:
                ...
                # In frozen apps (PyInstaller) the original .py source file is usually not available.
                # The function body is optional metadata; fall back to empty to avoid crashing.
                source_lines = ""
            # 移除装饰器和函数定义行
